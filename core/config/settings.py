...
class Settings(BaseSettings):
    ...
    llm_model: str = Field("qwen3:0.6b", env="LLM_MODEL")
    llm_api_url: str = Field("http://localhost:11434/api/generate", env="LLM_API_URL")
    llm_model_name: str = Field("qwen3:0.6b", env="LLM_MODEL_NAME")
    embedding_model: str = Field("BAAI/bge-small-en-v1.5", env="EMBEDDING_MODEL")
    embedding_service_url: str = Field("http://localhost:8000/document/embed/", env="EMBEDDING_SERVICE_URL")
